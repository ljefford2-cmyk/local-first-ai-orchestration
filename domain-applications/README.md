...
| [DRNT](personal-drnt/) | Personal AI gateway on a three-device ecosystem (Watch, Phone, Desktop) with local-first orchestration and self-imposed governance | Self-imposed: privacy by architecture (Context Packager), append-only audit log, graduated autonomy (WAL 0–3) — no external regulatory mandate | Six interface specifications, three governance artifacts (Event Schema, Capability Trust Profile, NemoClaw Governance Overlay) |
