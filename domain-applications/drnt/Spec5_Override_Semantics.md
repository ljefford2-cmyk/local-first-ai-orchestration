...
[Spec5_Override_Semantics.md](https://github.com/user-attachments/files/26163510/Spec5_Override_Semantics.md)
...
SUCCESSOR (J2, parent: J1, route.cloud.openai):
  ...
  11. model.response(J2), 12. job.delivered(J2)
...
SUCCESSOR (J2, parent: J1, route.multi):
  ...
  15. job.delivered(J2), 16. human.reviewed(J2, accepted)
...
*End of Spec 5 — FINAL. Complete DRNT Interface Specification: Spec 1 (Audit/Event Schema), Spec 2 (Capability Model), Spec 3 (Context Boundary), Spec 4 (Egress Policy Binding), Spec 5 (Override Semantics).*
