...
[Spec3_Context_Boundary.md](https://github.com/user-attachments/files/26163508/Spec3_Context_Boundary.md)
...
```json
{
  ...
  "task_specification": { "request_category", "parsed_intent", "output_format",
    "prompt_template_id", "prompt_template_version" },
  "retrieved_candidates": [
    { "source_id", "source_type": "user_input|memory_object|system_context",
      "shareability": "cloud_eligible|local_only",
      "confidence": 0.0-1.0, "excluded": bool,
      "exclusion_reason": "local_only|below_confidence|over_budget|null" }
  ],
  "eligible_context_fields": [
    { "field_id": "UUIDv7", "field_name", "source_type", "source_id",
      ...
      "shareability": "cloud_eligible", "confidence": 0.0-1.0,
      "content": "the actual data", "content_hash": "SHA-256" }
  ],
  "assembled_payload": "the prompt string",
  "assembled_payload_hash": "SHA-256",
  "token_estimate": 0, "created_at": "ISO 8601"
}
```
